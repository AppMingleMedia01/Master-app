...
import 'package:master_app/sliderScreens/theredscreen.dart';
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
                ...
                onPressed: (){navigatorPush(Theredscreen(), context: context);}, child: const Text('Next',style: TextStyle(color: Colors.white),)),
          )
